...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "nav-ai-amp-8209-agent-design",
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/purrfessor/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%69%6E%71%69.%6C%75@%55%4E%44.%65%64%75", "_blank");
        },
      },{
        id: 'social-facebook',
        title: 'Facebook',
        section: 'Socials',
        handler: () => {
          window.open("https://facebook.com/linqi.lu", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/LynLinqiLu", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=78Fr7LIAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
